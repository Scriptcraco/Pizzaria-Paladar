...
{
    Debug.LogWarning("[NPC_AtendenteDrive] carSpawner não atribuído! Carro não removido do spawner.");
}
            }
            else
            {
                Debug.Log("[NPC_AtendenteDrive] Estoque insuficiente para atender o cliente.");
            }
