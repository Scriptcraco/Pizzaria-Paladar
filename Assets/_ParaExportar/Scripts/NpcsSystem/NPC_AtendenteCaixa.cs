        ...
        private void Awake()
        {
            ...
            if (caixaVendaTrigger == null)
            {
                ...
                if (caixaVendaTriggerGO != null)
                    ...
                    Debug.LogError("CaixaVendaTrigger não encontrado com tag 'CaixaVendaTrigger'");
            }
            ...
            if (filaManager == null)
            {
                ...
                if (filaManagerGO != null)
                    ...
                    Debug.LogError("FilaCaixaManager não encontrado com tag 'FilaCaixaManager'");
            }
            ...
            if (player == null)
            {
                ...
                if (playerGO != null)
                    ...
                    Debug.LogError("Player não encontrado com tag 'Player'");
            }
        }
                ...
                if (clienteGO != null)
                {
                    ...
                    if (cliente != null && !cliente.pedidoEntregue && cliente.EstaParado())
                    {
                        ...
                        if (podeAtender)
                        {
                            ...
                            Debug.Log($"Cliente atendido. Pedido: {qtdPizza} pizza(s), {qtdBebida} bebida(s). Valor ganho: {valor}");
                        }
                        else
                        {
                            Debug.Log("Estoque insuficiente no caixa para atender o cliente.");
                        }
                    }
                }
                else
